...
fillRestaurantHTML = (restaurant = self.restaurant) => {
  ...
  name.innerHTML = 'Main information about ' + restaurant.name;
  name.setAttribute('tabindex', '0');

  const address = document.getElementById('restaurant-address');
  address.innerHTML = restaurant.address;
  address.setAttribute('tabindex', '0');
  address.setAttribute('aria-label', 'address of the restaurant is' + restaurant.address);
  ...
  image.alt = 'an image of the ' + restaurant.imageinfo;

  const cuisine = document.getElementById('restaurant-cuisine');
  cuisine.innerHTML = restaurant.cuisine_type;
  cuisine.setAttribute('tabindex', '0');
  cuisine.setAttribute('aria-label', 'type of cuisine is  ' + restaurant.cuisine_type);
